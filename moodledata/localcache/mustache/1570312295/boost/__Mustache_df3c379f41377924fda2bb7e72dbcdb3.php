...
class __Mustache_df3c379f41377924fda2bb7e72dbcdb3 extends Mustache_Template
{
...
';
                    ...
                    $buffer .= $this->sectionB60f26d566f9746787aa4b8bf561308b($context, $indent, $value);
                    $buffer .= $indent . '                                    </div>
';
                }
            }
...
';
    ...
    private function section4720eae5423982ed78802d72a0a44389(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB60f26d566f9746787aa4b8bf561308b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $this->section4720eae5423982ed78802d72a0a44389($context, $indent, $value);
                }
                // 'export' section
