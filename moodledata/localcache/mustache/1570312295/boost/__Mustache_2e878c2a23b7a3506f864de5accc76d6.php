...
class __Mustache_2e878c2a23b7a3506f864de5accc76d6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section90b87a45d2f3af8c0013e149d2e408d0($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section89034374ded9f2326e1b329fa8ee32f9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section90b87a45d2f3af8c0013e149d2e408d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section89034374ded9f2326e1b329fa8ee32f9($context, $indent, $value);
                $buffer .= $indent . '    ';
